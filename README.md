...
- Haga doble clic en vision_gui.exe. Se abrirá una
pantalla de consola, solo se debe esperar unos segundos hasta que se abra la aplicación real (de color blanco principalmente).

> Opción 2: Desde terminal/CMD (opcional):

1. Abra su terminal en la carpeta "dist"
- `cd \<ruta/del/proyecto\>/dist`
2. Ejecute el programa desde su línea de comandos
- `vision_gui.exe`
...
## Espacio para pegar imagen y botones para sacar códigos de cadena en directo. *(corresponde a la parte "1. Visualización de la Imagen") y también ("2.Código de Cadena")*
...
>**Importante** Cuide de tener la ventana en su máximo
tamaño, de lo contrario puede que no vea la cadena generada en el
cuadro de texto.

![](./media/media/image8.png)

## Archivo *(corresponde a la parte "1. Visualización de la Imagen")*
...
## Contorno *(corresponde a una parte del punto las propiedades geométricas)*


**Objetivo:** Mostrar el contorno del objeto binario encontrado, además de mostrar con un punto verde el punto de inicio/partida.
...
## Cadenas *(corresponde a la parte "2. Código de Cadena")*
...
- **F8**, calcula el código de cadena con el algoritmo F8. Se despliega el código de cadena en el cuadro de texto debajo de la imagen (para visualizarla por completo favor de maximizar la aplicación al tamaño completo de su pantalla).

- **AF8**, calcula el código de cadena con el algoritmo AF8. Se despliega el código de cadena en el cuadro de texto debajo de la imagen (para visualizarla por completo favor de maximizar la aplicación al tamaño completo de su pantalla).
...
- **3OT**, calcula el código de cadena con el algoritmo 3OT. Se despliega el código de cadena en el cuadro de texto debajo de la imagen (para visualizarla por completo favor de maximizar la aplicación al tamaño completo de su pantalla).

- **Guardar cadena**, abre el explorador de archivos para que el usuario guarde el código de cadena como un archivo .txt en su disco local con el nombre que el usuario decida.
...
## Decodificación *(corresponde a la parte "3. Decodificación")*
...
## Análisis *(corresponde a la parte "4. Histograma" y a la parte "5. Entropía de Shannon")*
...
## Descriptores *(corresponde a la parte "8. Propiedades Geométricas")*
...
## Comprimir *(corresponde a la parte "6. Comprensión de Huffman" y a "7. Compresión Aritmética")*
